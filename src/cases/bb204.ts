...
export const BB204_PARTICIPANTS: SeedParticipant[] = [
  {
    ...
    statement: [
      ...
      "My car spun round and came to rest against the kerb.",
      "The airbags went off.",
      "I did not hear a horn before the impact.",
      "It was dry and clear that evening.",
      "I got out and someone called 911.",
  ...
  },
  {
    ...
    statement: [
      ...
      "I braked hard and swerved left.",
      "There was broken glass across the road afterwards.",
      "It had been raining earlier so the road was wet.",
      "An ambulance came for the other driver.",
  ...
  },
  {
    ...
    statement: [
      ...
      "The Tesla spun round after they hit.",
      "Bystanders came over almost immediately.",
  ...
  },
  {
    ...
    statement: [
      ...
      "Someone got out of the Honda and was holding his neck.",
      "I called the police.",
      "The road looked dry to me.",
      "It was around 8:45.",
    ],
  },
];
